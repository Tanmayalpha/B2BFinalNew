...
GetHomeProductDetailsModel getHomeProductDetailsModelFromJson(String str) => GetHomeProductDetailsModel.fromJson(json.decode(str));

String getHomeProductDetailsModelToJson(GetHomeProductDetailsModel data) => json.encode(data.toJson());
...
class GetHomeProductDetailsModel {
  ...
  factory GetHomeProductDetailsModel.fromJson(Map<String, dynamic> json) => GetHomeProductDetailsModel(
    error: json["error"],
